...
ACCESS_TOKEN = 'EAAffskFvY7UBAHVKzukVICSCpjiq4CmZBkGlOIitYAqILJ99Ob7gDHJ8lUnOcyOGzSnI4EYA7FwXcBx3VexvenrXDsCjhkLR566A8o7wAfuQYZAZC8vEWZAKDtMtpBwZC1vwi43WDWTeWyWwKj1kAIkoDby0UZBM3rf1jkvso5fwZDZD'
          ...
          if ('message' in messaging[0]):
              for message in messaging:
                if message.get('message'):
                    ...
                    if recipient_id == '2107804756008733':
